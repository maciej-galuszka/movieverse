...
function Movies() {
  ...
  return (
    <section className="mx-auto grid min-h-full grid-cols-1 grid-rows-[auto_1fr] items-start justify-center gap-x-6 gap-y-4 px-12 pb-12 text-white sm:grid-cols-2 sm:gap-y-6 sm:px-9 lg:max-w-5xl lg:gap-x-10 lg:px-0">
      <MoviesSearchForm
      ...
      />
      {error === null ? (
        <h1 className="col-span-full mt-12 text-center text-2xl font-bold tracking-wide sm:mt-20 sm:text-5xl">
          Looking for a movie? <br /> Start here!
        </h1>
      ) : (
        <>
          <div className="min-h-full overflow-hidden rounded-xl bg-lightGray">
            <MovieList
              movies={movies}
              isLoading={isLoading}
              error={error}
          ...
          <div className="hidden min-h-full overflow-hidden rounded-xl bg-lightGray sm:block">
